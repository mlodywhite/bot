...
module.exports = {
    ...
    run: (msg, args, client) => {
        ...
        if (!serverid)
        {
            ...
            .setAuthor("Coś poszło nie tak!", `https://uxwing.com/wp-content/themes/uxwing/download/01-user_interface/red-x.png`)
            .setColor("RED")
            .setDescription("> Nie podałeś id serwera do nadania premium")
            .setFooter(`ShieldBot Bot 2020 - 2021 | ${botversion}`, msg.author.displayAvatarURL({dynamic: true}))
            return msg.inlineReply(Embed);
        }
        ...
        if (db.get(`premium_${msg.guild.id}`) == "true")
        {
            const Embed = new MessageEmbed()
            .setAuthor("Coś poszło nie tak!", `https://uxwing.com/wp-content/themes/uxwing/download/01-user_interface/red-x.png`)
            .setColor("RED")
            .setDescription("> Podany serwer posiada już premium!")
            .setFooter(`ShieldBot Bot 2020 - 2021 | ${botversion}`, msg.author.displayAvatarURL({dynamic: true}))
            return msg.inlineReply(Embed);
        }
        db.set(`premium_${msg.guild.id}`, "true")
        const embed2 = new MessageEmbed()
        .setColor("GREEN")
        .setAuthor("Premium Zostało Nadane!")
        .addField(`Serwer ID`, `${args[0]}`, false)
        .addField(`Premium nadane przez`, `<@${msg.author.id}>`, false)
